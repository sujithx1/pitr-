...
chmod +x "$SCRIPT_DIR/backup_with_alert.sh"
...
echo "=================================================="
echo "Installing Enterprise Backup Crontab Schedule"
...
# Fetch existing crontab without erroring if empty
EXISTING_CRON=$(crontab -l 2>/dev/null || true)

# Remove any existing pgBackRest cron entries to avoid duplicates
